...
hacerEj('TASK 1: Crear array de URLs', async () => {
    ...
    // Tu codigo aqui:
    const urls = [
        /* Tu codigo aqui — completa las 4 URLs */
    ];
...
hacerEj('TASK 2: Promise.allSettled', async () => {
    ...
    // Tu codigo aqui:
    const resultados = /* Tu codigo aqui — Promise.allSettled con fetch */;
...
hacerEj('TASK 4: Usuarios exitosos', async () => {
    ...
    const exitosos = /* Tu codigo aqui */;

    // Paso 2: Convierte a JSON
    const usuarios = /* Tu codigo aqui */;
